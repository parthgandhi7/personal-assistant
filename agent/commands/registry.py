...
class CommandRegistry:
    def __init__(self) -> None:
        self._commands: dict[str, CommandHandler] = {
            ...
            "close_application": system_commands.close_application,
            "open_browser": system_commands.open_browser,
            "open_url": system_commands.open_url,
            "search_web": system_commands.search_web,
            "search_website": system_commands.search_website,
            ...
            "delete_file": system_commands.delete_file,
            "copy_file": system_commands.copy_file,
            "move_file": system_commands.move_file,
            "create_file": system_commands.create_file,
            "find_file": system_commands.find_file,
        }
